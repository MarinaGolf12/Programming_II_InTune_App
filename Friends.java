...
class Friends extends JFrame implements ActionListener {
	...
	try {
		...
		while (rs.next()) {
		    ...
		    String s = " " + rs.getString("friendusername") + "\n";
		    r = r + s;
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == add) { //add a friend
		    ...
		    Connection conn = null;
            if (CheckFriends.friendExists(friendname.getText()) == true) {

			    if (friendname.equals(Entrancepage.tfusername.getText()) != true) {
        ...
        } else if (ae.getSource() == delete) { //delete a friend
        ...
        } else if (ae.getSource() == goback) { //go back to user's profile
