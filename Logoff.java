/**
 * @author Dimitra_Anastasia_Stathara
 */
package application;
...
public class Logoff {
 //This is the body of the class
  ...
  /**Declare the constructor of the class LogOff.*/
  public Logoff() {
//Body of the method
...
//Title available options of the Dialog Box
      ...
      showConfirmDialog(null, dialBox, "Logout From InTune App?",
...
//Display an informational message to the user
	    ...
	    "You are successfully logged off. Press OK to continue!");
...
//Title and available options of the Panel
	    ...
	    showConfirmDialog(null, confBox, "Logout Successful",
